<aside class="menu is-hidden-mobile">
    <ul class="menu-list mt-4">
        <li><a class="is-active"><i class="las la-comment mr-2""></i>Reviews</a></li>
        <li><a><i class="las la-reply mr-2"></i>Contact us</a></li>
    </ul>
</aside>
        ...
        <div class="relative flex items-center justify-between h-16">
          ...
          <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:block sm:ml-6">
              <div class="flex">
                <a href="/" class="px-3 py-2 rounded-md text-sm font-medium leading-5 text-white @if(Request::path() == '/') bg-gray-900 @endif">Dashboard</a>
