...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  if (reviewAppBtn) {
    axios.get(appDomain + '/reviews/average-stars/' + reviewAppBtn.getAttribute("data-product")).then(function (response) {
  ...
  var modal = new tingle_js_dist_tingle_min_js__WEBPACK_IMPORTED_MODULE_2___default.a.modal({
    ...
    onOpen: function onOpen() {
      ...
      if (parseInt(settings.rating) !== 1) {
        ...
        var formRater = rater({
          element: document.getElementById('form-rating'),
          starSize: 22
        });
      }
    },
  ...
  modal.setContent('<h2>Review</h2><div id="form-rating"></div><div id="review-form">' + '<input id="review-name-input" name="name" type="text" placeholder="Name">' + '<span id="review-name-input-error" class="invalid-feedback">Please enter your name</span>' + '<textarea id="review-description-textarea" rows="7" name="name" placeholder="Review"></textarea>' + '<span id="review-description-textarea-error" class="invalid-feedback">Please enter your review</span>' + '</div>');
