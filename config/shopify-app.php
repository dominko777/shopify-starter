...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,write_themes,read_customers'),
    ...
    */
    ...
    'myshopify_domain' => env('SHOPIFY_MYSHOPIFY_DOMAIN', 'it-modern-service.myshopify.com'),
